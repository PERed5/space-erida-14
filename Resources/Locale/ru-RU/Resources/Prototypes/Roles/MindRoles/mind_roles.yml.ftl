...
ent-MindRoleGhostRoleTeamAntagonistFlock = Роль призрака (Командный антагонист)
    .desc = { ent-MindRoleGhostRoleTeamAntagonist }
...
ent-MindRoleRevolutionary = Роль революционер
    .desc = { ent-MindRoleHeadRevolutionary }
