...
ent-CyborgEnergySwordDouble = { ent-EnergySwordDouble }
    .desc = Стажеры из командования Синдиката решили, что одного клинка на энергетическом мече недостаточно. Специальная разработка для киборгов InteQ.
    .suffix = Одноручное, Для боргов

ent-EnergyDaggerLoudBlue = {ent-EnergyDaggerLoud}
    .suffix = синий
    .desc = {ent-EnergyDaggerLoud}
