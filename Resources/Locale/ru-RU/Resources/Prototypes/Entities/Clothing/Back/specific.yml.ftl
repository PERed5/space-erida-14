...
ent-ClothingBackpackHarmpack = Х.А.Р.М. П.А.К.
    .desc = Теперь вы можете перезаряжать, готовить и перекусывать одновременно.

ent-XenoborgMaterialBag = хранилище силиконов
    .desc = Подделка бс сумки, может всасывать определенные материалы, непригодна для использования гуманоидами из-за вредных выбросов.
