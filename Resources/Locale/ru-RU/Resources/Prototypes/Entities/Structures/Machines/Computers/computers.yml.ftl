...
ent-ComputerNukieDelivery = компьютер доставки синдиката
    .desc =
        Компьютер, который может создавать bluespace в определенном оборудовании для ядерных операций.
        Печатная плата встроена в раму и не может быть восстановлена в случае разборки.
